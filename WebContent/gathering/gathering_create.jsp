...
<form action="<%=request.getContextPath()%>/GatherAddAction.do" method="post">
...
<table class="type">
	...
	<tr>
		...
		<td>
			<input name="gathersubject" id="gathersubject" type="text" size="50" maxlength="100" 
				value=""/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<th>
			<div align="center">게시판 비밀번호 설정</div>
		</th>
		<td>
			<input name="gatherpw" id="gatherpw" type="password" size="10" maxlength="10" 
				value=""/>
		</td>
	</tr>
	...
	<tr>
	<th>
		<div align="center">인원수</div>
		</th>
	<td><select id="membercnt" name="membercnt" style="width:300px">
